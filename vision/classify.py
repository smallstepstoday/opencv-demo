...
st.title("Deep Learning based Image Classification")
...
def load_model():
    ...
    with open("vision/classification_classes_ILSVRC2012.txt", "r") as f:
    ...
    model = cv2.dnn.readNet(model="vision/DenseNet_121.caffemodel", config="vision/DenseNet_121.prototxt", framework="Caffe")
